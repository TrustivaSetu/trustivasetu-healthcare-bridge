...
const REPORTS: ReportConfig[] = [
  {
    id: 'clinics',
    title: 'Clinic Master Report',
    description: 'Complete details for all clinics — basic info, banking, GST, PAN, schemes',
    icon: '🏥',
    color: 'blue',
    fields: [
      'Clinic Code (TSC-XXXXXX)',
      'Clinic Name',
      'Hospital Type',
      'Region',
      'Assigned RM',
  ...
  {
    id: 'schemes',
    title: 'Clinic Schemes Report',
    description: 'Agreed schemes for each clinic — subvention %, processing fee %, GST details',
    icon: '📋',
    color: 'purple',
    fields: [
      'Clinic Code',
